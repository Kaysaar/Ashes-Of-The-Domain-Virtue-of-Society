...
public class AoTDColonyEventSpec {
    ...
    public AoTDColonyEventSpec( String EventId,String Name, HashMap<String,String> Options,  boolean IsOneTimeEvent,boolean IsPermament, int Weight, String Plugin, String ModId, int BaseCooldown,String Image){
    ...
    public static AoTDColonyEventSpec initSpecFromJson(JSONObject object) throws JSONException {
         ...
         int duration = object.getInt("weight");
